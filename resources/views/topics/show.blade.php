                ...
                <div class="card mb-3">
                    ...
                    <div class="card-footer">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-2">
                                <a href="{{ route('reports.create', $topic) }}"
                                   class="btn btn-sm btn-block btn-outline-dark"> <i
                                ...
                                <div class="card mb-3 ml-5">
                                    ...
                                    <div class="card-footer">
                                        <div class="row d-flex align-items-center h-100">
                                            ...
                                            <div class="col-md-2">
                                                <form action="{{ route('replies.destroy', $response->id) }}"
                                                      class="form-inline"
                                                      method="POST">
                                                    @method('DELETE')
                                                    @csrf
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row justify-content-around mb-3 mt-3">
                            ...
                            <div class="col-md-5">
                                <form action="{{ route('topics.destroy', $topic->id) }}" class="form-inline"
                                      method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-sm btn-block btn-outline-danger" type="submit">Delete
